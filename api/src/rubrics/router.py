...
async def create_rubric_section(
    section_data: RubricSectionCreate,
    ...
    return await RubricsService.create_rubric_section(section_data, db_session)
...
async def create_rubric(
    ...
    return await RubricsService.create_rubric(rubric_data, db_session)
